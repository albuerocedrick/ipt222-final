            ...
            <div class="w-full h-2/5 border-b border-neutral/30 p-6">
                <div class="flex flex-row justify-between items-start">
                    ...
                    <div class="flex flex-row gap-2">
                        <button class="p-2 btn btn-warning rounded-2xl text-secondary-content hover-effect">
                        ...
                        <button class="p-2 btn btn-error rounded-2xl text-error-content hover-effect">
